...
<body class="worker-body">
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background-color:black"  >
        ...
        <form action="workerRegistration.html" method="post" onsubmit="return validation()">
          <div class="container">
            <div class="row">
                <div class="col-md-10 offset=md-1">
                    <div class="row">
                        <div class="col-md-5 register-left">
                            <img src="resources/css/worker-logo.png"/>
                            <h3>Join us</h3>
                                ...
                                <div class="form-group">
                                        <p>Skill</p>
                                            <div class="form-check-inline">
                                                ...
                                                <input type="checkbox" class="form-check-input" id="check1" name="skills" value="Mechanic" checked>Mechanic
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                                <label class="form-check-label" for="check2">
                                                <input type="checkbox" class="form-check-input" id="check2" name="vehicle2" value="something">Electrician
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                <input type="checkbox" class="form-check-input" id="check2" name="vehicle2" value="something">Plumber
                                                </label>
                                            </div>
                                    </div>
